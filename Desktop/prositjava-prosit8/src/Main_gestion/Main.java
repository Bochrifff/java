...
public class Main {
    ...
    Animal lion=new Animal("cats","tiggy",10,true);
       ...
       // myzoo.afficher();
        ...
        Penguin penguin1 = new Penguin("Animal", "fathi", 4, true, "Ocean", 33.6f);
        penguin1.eat_meat(Food.MEAT);

        Dophin dolphin2 = new Dophin("Delphin", "walii", 6, true, "medi", 22.f);
        dophin.eat_meat(Food.MEAT);
